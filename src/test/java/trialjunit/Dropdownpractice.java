...
public class Dropdownpractice {
	...
	public void clickingcustomerslink() throws InterruptedException {
		...
		By grouplocr=By.xpath("//*[@id=\"group\"]");
		driver.findElement(grouplocr).click();
		Select sel1=new Select((driver.findElement(grouplocr)));
		sel1.selectByVisibleText("April2020");
		//Thread.sleep(2000);
		//sel.selectByIndex(2);
	By countryloc=By.xpath("//Select[@id='country']");
	driver.findElement(countryloc);
	Select sel2=new Select((driver.findElement(countryloc)));
